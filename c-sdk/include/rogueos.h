/* rogueos.h — RogueOS syscall ABI for C/C++ applications.
 *
 ...
 *
 * Compile for bare-metal RogueOS:
 *   x86_64-elf-gcc -ffreestanding -nostdlib -o app.elf app.c crt0.o libk.o
 *
 * For Linux dev testing, compile with -DROGUEOS_LINUX and link linux/kwm_linux.c
...
#ifndef ROGUEOS_LINUX /* bare-metal: real SYSCALL instruction */
...
#else /* ROGUEOS_LINUX — redirect to linux/kwm_linux.c shim */
